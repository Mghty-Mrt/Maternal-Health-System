    ...
    <aside class="left-sidebar bg-home">
      ...
      <div>
        ...
        <div class="brand-logo d-flex align-items-center justify-content-center">
          <a href="../barangay/dashboard" class="text-nowrap logo-img">
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="../barangay/dashboard" aria-expanded="false">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="../barangay/residents" aria-expanded="false">
              <span class="text-light" style="margin-left: 10px">
                <i class="far fa-address-book" style="font-size: 20px; padding-right: 4px"></i>
                </span>
                <span class="hide-menu fw-bold text-light">Resident List</span>
              </a>
            </li>
            ...
            <li class="sidebar-item">
              ...
              <span class="text-light" style="margin-left: 10px">
                <i class="far fa-question-circle" style="font-size: 20px; padding-right: 4px"></i>
                </span>
