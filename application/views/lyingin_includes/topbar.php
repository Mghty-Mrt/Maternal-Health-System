        ...
        <li class="nav-item dropdown">
                          ...
                          <?php foreach($notif as $no){ ?>
                            <a
                              <?php if($no->notification_type_id  == 2) { ?>
                                href="../lyingin/referlist" onclick="readnotif(<?= $no->notification_type_id ?>)" 
          ...
          <?php foreach ($user_info as $info) { ?>
            ...
            <?php } ?>
                ...
                <a href="../lyingin/profile" class="d-flex align-items-center gap-2 dropdown-item">
                  <i class="ti ti-user fs-6"></i>
                  <p class="mb-0 fs-3">Profile</p>
                </a>
                <a href="../lyingin/account" class="d-flex align-items-center gap-2 dropdown-item">
    ...
    function logout(){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "<?php print '../lyingin/confirm_logout'; ?>";
            } else {
                // location.reload();
            }
        });
