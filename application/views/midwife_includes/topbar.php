        ...
        <li class="nav-item dropdown">
          ...
          <li class="nav-item dropdown">
              <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown" aria-expanded="false">
                <?php if ($info->image == "") { ?>
                  <img src="../assets/images/profile/default.jpg" alt="default profile" class="rounded-circle" width="35" height="35">
                <?php } else { ?>
                  <img src="/mhs_micro/profile/<?php print $info->image ?>?t=<?= time() ?>" class="rounded-circle" width="35" height="35" alt="">
                <?php } ?>
              </a>
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
              <div class="message-body">
                ...
                <a href="../midwife/account" class="d-flex align-items-center gap-2 dropdown-item">
    ...
    function logout(){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "<?php print '../midwife/confirm_logout'; ?>";
            } else {
                // location.reload();
            }
        });
