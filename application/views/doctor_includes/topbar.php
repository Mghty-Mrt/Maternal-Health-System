                      ...
                      <div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden scroll;">
                        <div class="simplebar-content bg-light" style="padding: 0px; overflow:hidden scroll">
                          ...
                          <?php foreach($notif as $no){ ?>
                            <a
                              <?php if($no->notification_type_id  == 1) { ?>
                                href="../doctor/newpatients" onclick="readnotif(<?= $no->notification_type_id ?>)" 
                              <?php }elseif($no->notification_type_id  == 1) { ?>
                                href="#" 
                              <?php } ?>
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                <div class="message-body">
                  <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                    ...
                    <?php } else { ?>
                      <img src="/mhs_micro/profile/<?php print $info->image ?>" class="rounded-circle" width="70" height="70" alt="">
                    <?php } ?>
                    <div class="ms-3">
                ...
                <a href="../doctor/profile" class="d-flex align-items-center gap-2 dropdown-item">
                  <i class="ti ti-user fs-6"></i>
                  <p class="mb-0 fs-3">Profile</p>
                </a>
                <a href="../doctor/account" class="d-flex align-items-center gap-2 dropdown-item">
