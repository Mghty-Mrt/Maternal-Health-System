    ...
    <div class="card" id="saveitrfrom">
        <div class="card-body">
            <form id="itrForm">
                ...
                <?php foreach ($itrRecord as $editperinfo) { ?>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <textarea name="drorder" id="drorder" cols="1000" rows="60" class="rounded-2 p-3 form-control border-0 shadow-none" readonly><?= $editperinfo->doctor_order ?></textarea>
        ...
        <div class="col-md-12 d-flex justify-content-end mt-3">
            ...
            <button type="button" class="btn btn-warning printitrform" onclick=printitr()>Print <i class="fas fa-print"></i></button>
        </div>
    <?php } ?>
    </div>
</div>
