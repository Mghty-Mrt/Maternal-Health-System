    ...
    <div class="card">
        <div class="card-body">
            ...
            <div id="positiveSection">
                ...
                <div class="row">
                    <?php foreach ($patientinfo as $p_info) { ?>

                        <input type="hidden" name="ppreid" id="ppreid" value="<?= $p_info->ppreid ?>">
                        <input type="hidden" name="access_code_id" id="access_code_id" value="<?= $p_info->access_code_id ?>">
                        <div class="col-md-8">
                            <label for="pname">Patient's Name</label>
                            <div class="input-group mb-3">
                                <input type="text" name="pname" id="pname" class="form-control shadow-none" value="<?= $p_info->firstname ?> <?= $p_info->middlename ?> <?= $p_info->lastname ?>" readonly>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-3">
                                <input type="number" name="page" id="page" class="form-control shadow-none" value="<?= $p_info->age ?>" readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <label for="findings">Address</label>
                            <div class="input-group mb-3">
                                <input type="text" name="paddress" id="paddress" class="form-control shadow-none" value="<?= $p_info->street ?> <?= $p_info->fname ?> <?= $p_info->city ?>" readonly>
                            </div>
                        </div>
                </div>
            <?php } ?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <textarea name="dr_order" id="dr_order" cols="500" rows="60" class="form-control shadow-none"></textarea>
                            ...
                            <td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" id="temp" name="temp" class="form-control shadow-none">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" id="bp" name="bp" class="form-control shadow-none">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <select class="form-select mr-sm-2 form-control shadow-none" name="typeofdelivery" id="typeofdelivery">
                                                ...
                                                <option value="Ceasarean Section">Dilatation and Curettage</option>
                                                <option value="Ceasarean Section">Forcep Delivery</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="date" name="datedelivery" id="datedelivery" class="form-control shadow-none" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" id="placedel" name="placedel" class="form-control shadow-none">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" id="outcome" name="outcome" class="form-control shadow-none">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" id="babyweight" name="babyweight" class="form-control shadow-none">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" id="attendby" name="attendby" class="form-control shadow-none">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <label>Intention to used FP Method:</label><br>
                                        <div class="input-group mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" id="vacsupp" name="vacsupp" class="form-control shadow-none">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" id="fessupp" name="fessupp" class="form-control shadow-none">
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" id="breast" name="breast" class="form-control shadow-none">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Uterus</label><br>
                                                <div class="input-group mb-3">
                                                    <input type="text" id="uterus" name="uterus" class="form-control shadow-none">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" id="present" name="present" class="form-control shadow-none">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Absent</label><br>
                                                <div class="input-group mb-3">
                                                    <input type="text" id="absent" name="absent" class="form-control shadow-none">
                                                </div>
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div class="input-group mb-6">
                                                <input type="text" id="laceration_episiotomy" name="laceration_episiotomy" class="form-control shadow-none">
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <div>
                                                    <input type="checkbox" class="form-check-input shadow-none" id="personalhygiene" name="ac_personalhygiene" value="Personal Hygiene">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div>
                                                    <input type="checkbox" class="form-check-input shadow-none" id="immunization" name="ac_immunization" value="Immunization">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div>
                                                    <input type="checkbox" class="form-check-input shadow-none" id="nutrition" name="ac_nutrition" value="Nutrition">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div>
                                                    <input type="checkbox" class="form-check-input shadow-none" id="famplan" name="ac_famplan" value="Family Planning">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div>
                                                        <input type="checkbox" class="form-check-input shadow-none" id="vaginal" name="advice_counsel_dsign_vaginal" value="Vaginal Bleeding">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div>
                                                        <input type="checkbox" class="form-check-input shadow-none" id="fever" name="advice_counsel_dsign_fever" value="Fever">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div>
                                                        <input type="checkbox" class="form-check-input shadow-none" id="abpain" name="advice_counsel_dsign_abpain" value="Severe Abdominal Pain"><br>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div>
                                                        <input type="checkbox" class="form-check-input shadow-none" id="vomiting" name="advice_counsel_dsign_vomiting" value="Severe Vomiting"><br>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div>
                                                        <input type="checkbox" class="form-check-input shadow-none" id="headache" name="advice_counsel_dsign_headache" value="Severe Headache"><br>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div>
                                                        <input type="checkbox" class="form-check-input shadow-none" id="UC" name="advice_counsel_dsign_UC" value="Unconscious/Convulsing"><br>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div>
                                                        <input type="checkbox" class="form-check-input shadow-none" id="ill" name="advice_counsel_dsign_ill" value="Looks Very Ill"><br>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div>
                                                        ...
                                                        <div class="input-group mb-6">
                                                            <input type="text" id="medicalprob" name="advice_counsel_dsign_medicalprob" class="form-control shadow-none">
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" id="followUp_date" name="followUp_date" class="form-control shadow-none">

                                                </div>
                                                <div class="col-md-6">
                                                    <label>Follow-Up Time</label>
                                                    <input type="time" id="followUp_time" name="followUp_time" class="form-control shadow-none">
                                                </div>
