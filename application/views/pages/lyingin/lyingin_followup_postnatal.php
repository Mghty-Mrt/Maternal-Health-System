    ...
    <div class="card">
        <div class="card-body">
            ...
            <div id="positiveSection">
                ...
                <div class="row">
                    <?php foreach ($PostnatalRecords as $postrec) { ?>
                        ...
                        <input type="hidden" name="ppreid" id="ppreid" value="<?= $postrec->pre_registration_id ?>">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <select class="form-select mr-sm-2 form-control shadow-none" name="typeofdelivery" id="typeofdelivery">
                                                <option selected><?= $note['Patient_Type_of_Delivery'] ?? '' ?></option>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <label>Visits <small class="text-info">NOTE: (<?= $postrec->visits ?>)</small></label>
                                                    <input list="postc" type="text" name="visits" id="visits" class="form-control shadow-none">
                                                    <datalist id="postc">
                                                        <option value="2nd Checkup">2nd Checkup</option>
                                                        <option value="3rd Checkup">3rd Checkup</option>
                                                        <option value="4th Checkup">4th Checkup</option>
                                                        <option value="5th Checkup">5th Checkup</option>
                                                        <option value="6th Checkup">6th Checkup</option>
                                                        <option value="7th Checkup">7th Checkup</option>
                                                    </datalist>
                                                </div>
            ...
            <div class="col-md-12 d-flex justify-content-end mt-3">
                <button type="button" id="submitbtn" class="btn btn-success" onclick="postnatal()"> Submit <i class="fas fa-save"></i></button>
                <button type="button" class="btn btn-warning btnprint" style="display: none" onclick="PrintPost()"> Print <i class="fas fa-print"></i></button>
            </div>
...
<script>
    ...
    function PrintPost() {
        ...
        var htmlElement = document.getElementById('postnatalForm');
