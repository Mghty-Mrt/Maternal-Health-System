                    ...
                    <tbody id="tbl_content">
                        <?php foreach ($PatientsItr as $itr) { ?>
                            <tr id="tr">
                                ...
                                <td class="border-bottom-0">
                                    <?= $itr->rlcode  ?>. <?= $itr->fname  ?> <?= $itr->lname  ?>
                                </td>
                                <td class="border-bottom-0">
                                    <?php if($itr->checkUpStatus == 0) { ?>
                                        <!-- <a href="../doctor/preItrCheckup?id=<?= $itr->pid ?>" class="btn btn-secondary fs-2 btn-sm btnCheck"><i class="fs-3 ti ti-file-pencil"></i> Prenatal Checkup</a> -->
                                        <a href="../doctor/PrefollowupCheckup?id=<?= $itr->pid ?>" class="btn btn-primary fs-2 btn-sm btnCheck"><i class="fs-3 ti ti-file-pencil"></i> Follow-up Checkup</a>
                                    <?php } else { ?>
                                        <button type="button" class="btn bg-primary-subtle text-secondary fs-2 btn-sm"> <i class="fas fa-check-circle"></i> Done Checkup</button>
                                    <?php } ?>
                                </td>
                                <td>
                                    <div class="dropdown dropstart">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" data-popper-placement="left-start">
                                            ...
                                            <li>
                                                <!-- <a class="dropdown-item d-flex align-items-center gap-3 text-success" href="../doctor/itrEdit?id=<?= $itr->piid ?>"><i class="fs-4 ti ti-edit"></i>Edit</a> -->
                                                <a class="dropdown-item d-flex align-items-center gap-3 text-secondary" href="../doctor/itrEdit?id=<?= $itr->piid ?>"><i class="fs-4 ti ti-eye"></i>View</a>
                                            </li>
                                            <li>
