        ...
        <div class="card-body">
            ...
            <form id="indexForm">
                ...
                <div class="col-md-12 mt-3">
                    ...
                    <input type="text" class="form-control shadow-none" id="address" placeholder="Address" value="<?= $preg[0]->street ?> <?= $preg[0]->fname ?> <?php if ($preg[0]->city == "") { print 'Quezon City'; } else{ print $preg[0]->city; } ?>" readonly>
                </div>
