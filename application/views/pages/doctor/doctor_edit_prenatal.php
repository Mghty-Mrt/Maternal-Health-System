    ...
    <div class="card">
        <div class="card-body">
            <div id="saveprentalform">
                <?php foreach ($edit_prenatal as $perinfo) { ?>
                    ...
                    <div class="row">
                        ...
                        <?php
                            $patient_other_info = json_decode($perinfo->patient_other, true);
                        ?>

                        <div class="col-md-12">
                            <label for="pstatus">Date/Place of Marriage</label>
                            <div class="input-group mb-3">
                                <input type="text" name="marriage" id="marriage" class="form-control shadow-none" value="<?= $patient_other_info['marriage'] ?? '' ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-3">
                                <input type="number" name="patcontactno." id="patcontactno" class="form-control shadow-none" value="<?= $perinfo->mobileno ?>" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="patphno" id="patphno" class="form-control shadow-none" placeholder="xx-xxxxxxxxx-x" value="<?= $patient_other_info['patphno'] ?? '' ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label for="pstatus">Referred By</label>
                            <div class="input-group mb-3">
                                <input type="text" name="patref" id="patref" class="form-control shadow-none" value="<?= $patient_other_info['patref'] ?? '' ?>">
                            </div>
                        </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <textarea name="dr_order" id="dr_order" cols="1000" rows="93" class="rounded-2 p-3 form-control shadow-none border-0"><?= $perinfo->dr_order ?></textarea>
                                    ...
                                    <td>
                                        ...
                                        <div class="row">
                                            <?php
                                            // Decode the JSON data
                                            $notesData = json_decode($perinfo->midwives_notes, true);
                                            ?>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" id="itnerval" name="interval" class="form-control shadow-none" value="<?= $notesData['Itnerval'] ?? '' ?>" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover text-nowrap mb-0 align-middle text-center">
                                                    <thead class="text-dark fs-4 bg-light">
                                                        ...
                                                        <?php $obx = json_decode($perinfo->ob_hx, true); ?>
                                                        <tr>
                                                            <th class="border-bottom-0">
                                                                <h6 class=" mb-0">OB Hx</h6>
                                                            </th>
                                                            <th class="border-bottom-0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="border-bottom-0">
                                                                ...
                                                                <input type="number" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G1_y" value="<?= $obx['G1_y'] ?? '' ?>"> <!--pwede gawing dropdown-->

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G1_td" value="<?= $obx['G1_td'] ?? '' ?>"> <!--pwede gawing dropdown-->

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G1_sex" value="<?= $obx['G1_sex'] ?? '' ?>"> <!--pwede gawing dropdown-->

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G1_wt" value="<?= $obx['G1_wt'] ?? '' ?>">

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G1_by" value="<?= $obx['G1_by'] ?? '' ?>">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="border-bottom-0">
                                                                ...
                                                                <input type="number" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G2_y" value="<?= $obx['G2_y'] ?? '' ?>"> <!--pwede gawing dropdown-->

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G2_td" value="<?= $obx['G2_td'] ?? '' ?>"> <!--pwede gawing dropdown-->

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G2_sex" value="<?= $obx['G2_sex'] ?? '' ?>"> <!--pwede gawing dropdown-->

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G2_wt" value="<?= $obx['G2_wt'] ?? '' ?>">

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G2_by" value="<?= $obx['G2_by'] ?? '' ?>">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="border-bottom-0">
                                                                ...
                                                                <input type="number" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G3_y" value="<?= $obx['G3_y'] ?? '' ?>"> <!--pwede gawing dropdown-->

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G3_td" value="<?= $obx['G3_td'] ?? '' ?>"> <!--pwede gawing dropdown-->

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G3_sex" value="<?= $obx['G3_sex'] ?? '' ?>"> <!--pwede gawing dropdown-->

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G3_wt" value="<?= $obx['G3_wt'] ?? '' ?>">

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G3_by" value="<?= $obx['G3_by'] ?? '' ?>">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="border-bottom-0">
                                                                ...
                                                                <input type="number" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G4_y" value="<?= $obx['G4_y'] ?? '' ?>"> <!--pwede gawing dropdown-->

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G4_td" value="<?= $obx['G4_td'] ?? '' ?>"> <!--pwede gawing dropdown-->

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G4_sex" value="<?= $obx['G4_sex'] ?? '' ?>"> <!--pwede gawing dropdown-->

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G4_wt" value="<?= $obx['G4_wt'] ?? '' ?>">

                                                            </th>
                                                            <th class="border-bottom-0">

                                                                <input type="text" class="text-center col-md-12 fs-2 p-1 rounded-1 shadow-none" style="border: 1px solid lightgray" id="G4_by" value="<?= $obx['G4_by'] ?? '' ?>">
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" id="tdstatus" name="tdstatus" class="form-control shadow-none" value="<?= $notesData['TD_Status'] ?? '' ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="">Tetanus Diptheria Given</label><br>
                                                        <div class="input-group mb-3">
                                                            <input type="date" id="tdgiven" name="tdgiven" class="form-control shadow-none" value="<?= $notesData['TD_Given'] ?? '' ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="">
                                                        <div class="">
                                                            ...
                                                            <div class="input-group mb-6">
                                                                <input type="text" id="hypertension" name="others" class="form-control shadow-none" value="<?= $medical_historyData['Others'] ?? '' ?>" >
                                                            </div>
                                                    ...
                                                    <?php
                                                        // Decode the JSON data
                                                        $family_medical_historyData = json_decode($perinfo->family_medical_history, true);
                                                        $family_medical_historyData = is_array($family_medical_historyData) ? $family_medical_historyData : [];
                                                    ?>

                                                        <div class="col-md-4">
                                                            <label for="hypertension" class="">Hypertension</label><br>
                                                            <div class="">
                                                                <input type="checkbox" class="form-check-input shadow-none" id="hypertensionmh" name="family_medical_history_hypertensionmh" class="" value="HypertensionMH" <?= in_array('HypertensionMH', $family_medical_historyData) ? 'checked' : '' ?>>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="">
                                                                <input type="checkbox" class="form-check-input shadow-none" id="TBmh" name="family_medical_history_TBmh" class="" value="TubercolosisMh" <?= in_array('TubercolosisMh', $family_medical_historyData) ? 'checked' : '' ?>>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="">
                                                                <input type="checkbox" class="form-check-input shadow-none" id="diabetesmh" name="family_medical_history_diabetesmh" class="" value="DiabetesMH" <?= in_array('DiabetesMH', $family_medical_historyData) ? 'checked' : '' ?>><br>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="mb-2 mt-3">
                                                        <div class="">
                                                            ...
                                                            <div class="input-group mb-6">
                                                                <input type="text" id="fpmethod" name="fpmethod" class="form-control shadow-none" value="<?= $notesData['FT_Method'] ?? '' ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" id="PR" name="PR" class="form-control shadow-none" value="<?= $notesData['PR'] ?? '' ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" id="RR" name="RR" class="form-control shadow-none" value="<?= $notesData['RR'] ?? '' ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" id="Right" name="Right" class="form-control shadow-none" value="<?= $notesData['Right'] ?? '' ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" id="Left" name="Left" class="form-control shadow-none" value="<?= $notesData['Left'] ?? '' ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" id="L3" name="lmlmp" class="form-control shadow-none" value="<?= $notesData['L3'] ?? '' ?>" >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" id="Presentation" name="Presentation" class="form-control shadow-none" value="<?= $notesData['Presentation'] ?? '' ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" id="FH" name="FH" class="form-control shadow-none" value="<?= $notesData['FH'] ?? '' ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="">Fetal Heart Tone</label><br>
                                                        <div class="input-group mb-3">
                                                            <input type="text" id="FHT" name="FHT" class="form-control shadow-none" value="<?= $notesData['FHT'] ?? '' ?>" >
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group mb-6">
                                                            <input type="text" id="fesopen" name="fesopen" class="form-control shadow-none" value="<?= $notesData['fesopen'] ?? '' ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="">Calcium Carbonate</label><br>
                                                        <div class="input-group mb-6">
                                                            <input type="text" id="calcar" name="calcar" class="form-control shadow-none" value="<?= $notesData['calcar'] ?? '' ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <?php
                                                    // Decode the JSON data
                                                    $counselingData = json_decode($husband[0]->counseling, true);
                                                    ?>
            ...
            <div class="col-md-12 d-flex justify-content-end mt-3">
                ...
                <button type="button" onclick="updatePrenatal()" class="btn btn-primary submitpre">Save Changes <i class="fas fa-save"></i></button>
...
<script>
    function updatePrenatal() {
        ...
        medical_history_data['Others'] = $('#m_Others').val();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                Toast.fire({
                    icon: "success",
                    title: "Prenatal updated successfully  "
                });
            },
