    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <input type="hidden" id="nbrid" value="0">
                <input type="hidden" id="pid" value="<?= $newbornrecord2[0]->pid ?>">


                <div class="col-md-6 mt-3">
                    <label for="" class="">Name of Child</label>
                    <input type="text" class="form-control shadow-none" id="child" name="baby_info_child">
                </div>
                ...
                <div class="col-md-3 mt-3">
                    <div class="row mt-4">
                        <div class="col-md-4">
                            <input type="checkbox" class="form-check-input" id="male" name="baby_info_male" value="Male">
                            <label class="form-check-label" for="exampleCheck1">Male</label>
                        </div>
                        <div class="col-md-5">
                            <input type="checkbox" class="form-check-input" id="female" name="baby_info_female" value="Female">
                ...
                <div class="col-md-4 mt-3">
                    ...
                    <input type="date" class="form-control shadow-none" id="dateofbirth" name="baby_info_dateofbirth" >
                </div>
                ...
                <div class="col-md-4 mt-3">
                    ...
                    <input type="text" class="form-control shadow-none" id="moName" name="moName" value="<?php print $newbornrecord2[0]->firstname ?> <?php print $newbornrecord2[0]->middlename ?> <?php print $newbornrecord2[0]->lastname ?> ">
                </div>


                <div class="col-md-4 mt-3 mb-3">
                    <label for="" class="">Educ Attainment:</label>
                ...
                <div class="col-md-4 mt-3 mb-3">
                    ...
                    <input type="text" class="form-control shadow-none" id="occupation" name="occupation" value="<?php print $newbornrecord2[0]->occupation ?>">
                </div>

                <?php
                // Decode the JSON data
                $fatherData = json_decode($newbornrecord2[0]->husband_data, true);
                ...
                <div class="col-md-4">
                    <label for="address" class="">Educ Attainment:</label>
                ...
                <div class="col-md-12 mt-3 mb-3">
                    ...
                    <input type="text" class="form-control shadow-none" id="address" name="address" value="<?php print $newbornrecord2[0]->street ?> <?php print $newbornrecord2[0]->fname ?> Quezon City">
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control shadow-none" id="birthWt" name="baby_info_birthWt">
                </div>

                <div class="col-md-3">
                    <label for="address" class="">Time of Delivery</label>
                    <input type="time" class="form-control shadow-none" id="timeofdel" name="baby_info_timeofdel">
                </div>
                ...
                <div class="col-md-3 ">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <label class="form-check-label" for="exampleCheck1">TT1</label>
                        </div>
                        <div class="col-md-2">
                ...
                <div class="col-md-4 mt-3">
                    <label for="" class="">Vit. A: (6M) </label>
