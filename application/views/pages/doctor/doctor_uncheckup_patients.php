<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <h5 class="card-title fw-bold text-uppercase fs-3 mb-4"> <i class="ti ti-layout-dashboard fs-3"></i> Dashboard / <span class="text-muted">Pending Patients</span></h5>
                </div>
                        ...
                        <?php foreach ($uncheckpatientst as $today) { ?>
                            <tr id="tr">
                                ...
                                <?php } elseif($today->pstat == 2){ ?>
                                    <td>
                                        <button type="button" class="btn btn-success fs-2 btn-sm"><i class="fas fa-check-circle"></i> Patient Refered</button>
                                    </td>
                                <?php } ?>
                            </tr>
                        <?php } ?>
