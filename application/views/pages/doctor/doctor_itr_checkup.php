                    ...
                    <div id="positiveSection">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" name="hf_name" id="hf_name" class="form-control shadow-none">
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" name="hm_name" id="hm_name" class="form-control shadow-none">
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" name="hl_name" id="hl_name" class="form-control shadow-none">
                                </div>
                            </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <textarea name="drorder" id="drorder" cols="1000" rows="57" class="rounded-2 p-3 form-control shadow-none border-0" placeholder="Type your notes here..."></textarea>
                                        ...
                                        <td>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="date" id="LMP" name="LMP" class="form-control shadow-none" onchange="calculate()">
                                                    </div>
                                                </div>
                                                ...
                                                <script>
                                                    function calculate() {
                                                        var lmpDate = new Date(document.getElementById('LMP').value);
                                                        var edcDate = new Date(lmpDate.getTime() + 280 * 24 * 60 * 60 * 1000); // Adding 280 days (40 weeks) to LMP
                                                        var edcFormatted = edcDate.toISOString().split('T')[0];
                                                        document.getElementById('EDC').value = edcFormatted;

                                                        var currentDate = new Date();
                                                        var differenceInMilliseconds = currentDate - lmpDate;
                                                        var aogWeeks = Math.floor(differenceInMilliseconds / (7 * 24 * 60 * 60 * 1000));
                                                        var aogDays = Math.floor((differenceInMilliseconds % (7 * 24 * 60 * 60 * 1000)) / (24 * 60 * 60 * 1000));
                                                        document.getElementById('AOG').value = aogWeeks + " weeks and " + aogDays + " days";
                                                    }
                                                </script>
                        ...
                        <div class="row">
                            <div class="col-md-4 mt-3">
                                ...
                                <div class="input-group mb-3">
                                    <!-- <select class="form-select shadow-none mr-sm-2" name="pstatus" id="pstatus" onchange="positive()"> -->
...
<script>
    function positive() {
        // Check if the selected value is "Positive"
        var p_name = $('#p_name').val();
        var followUp = $('#followUp').val();

        var pstatusValue = $('#pstatus').val();

        if (pstatusValue === "2") {
            // If positive and has medical and personal history, show the modal
