<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <h5 class="card-title fw-bold text-uppercase fs-3 mb-4"> <i class="ti ti-layout-dashboard fs-3"></i> Dashboard / <span class="text-muted">Postnatal Records</span></h5>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover text-nowrap mb-2 align-middle text-center" id="postnatal" data-order='[[0,"desc"]]'>
                    <thead class="text-dark fs-3 bg-home">
                        <tr>
                            <th class="border-bottom-0">
                                <h6 class="fw-semibold text-uppercase fs-2 text-light mb-0">Postnatal ID</h6>
                            </th>
                            <th class="border-bottom-0">
                    ...
                    <tbody id="tbl_content">
                        <?php foreach($postnatal as $p ) { ?>
                            <tr id="tr">
                                ...
                                <td><?= $p->visits ?></td>
                                <td><?= date('M, d Y \a\t h:i a', strtotime($p->pndate)) ?></td>
                                <td>
                                    <?php if($p->pnstat == 1) { ?>
                                    <span class="text-secondary fw-bold bg-secondary-subtle p-1 rounded-1 fs-2"><i class="fas fa-heartbeat me-1"></i>Recovering</span>
                                    <?php } elseif($p->pnstat == 2) { ?>
                                ...
                                <td>
                                    <div class="dropdown dropstart">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" data-popper-placement="left-start">
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3 text-secondary" href="../doctor/viewpostnatal?id=<?= $p->pnid ?>"><i class="fs-4 ti ti-eye"></i>View</a>
                                            </li>
                                            <!-- <li>
...
<script>
    ...
    function dlToExcel() {
        ...
        var tableTitle = "Postnatal_record";
