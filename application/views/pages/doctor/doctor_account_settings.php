                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="card w-100 position-relative overflow-hidden">
                            <div class="card-body p-4">
                                <form id="profileForm" action="../doctor/saveprofile" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="card w-100 position-relative overflow-hidden">
                            <div class="card-body p-4">
                                ...
                                <form id="accountForm" action="../doctor/updatePass" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-center justify-content-end mt-4 gap-3">
                                            ...
                                            <a href="../doctor/account" class="btn bg-danger-subtle text-danger">Cancel</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
