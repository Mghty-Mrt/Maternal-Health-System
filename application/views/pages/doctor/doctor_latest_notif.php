                    ...
                    <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                        <div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden scroll;">
                            <div class="simplebar-content bg-light" style="padding: 0px; overflow:hidden scroll">
                                ...
                                <?php foreach ($new_notif as $no) { ?>
                                    <a <?php if ($no->notification_type_id  == 1) { ?> href="../doctor/newpatients" onclick="readnotif(<?= $no->notification_type_id ?>)" <?php } elseif ($no->notification_type_id  == 1) { ?> href="#" <?php } ?> class="py-6 px-7 d-flex align-items-center dropdown-item">
                                        <span class="me-3">
                                            <?php if ($no->image == "") { ?>
