            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between">
                    <?php if ($facilityAvailability && $havailableCount != 0) { ?>
                        ...
                        <a id="referralLink" href="../doctor/referralform?id=<?php echo $facility->fid ?>&patient_id=<?php echo $patient_id ?>&case_id=<?php print $case_id ?>" class="card-link">Proceed <i class="fas fa-angle-right"></i></a>
                    <?php } else { ?>
                        <!-- <a href="#" class="card-link">View details</a> -->
