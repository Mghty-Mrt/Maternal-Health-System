    ...
    <div class="card overflow-hidden chat-application" style="height: 670px;">
        ...
        <div class="d-flex w-100">
                            ...
                            <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                                <div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden;">
                                    <div class="simplebar-content" style="padding: 0px;">
                                        ...
                                        <li class="list-group-item border-0 p-0 mx-9">
                                            <a class="d-flex align-items-center gap-6 list-group-item-action text-dark px-3 py-8 mb-1 rounded-1 bg-light-subtle" href="../doctor/viewmessage"><i class="ti ti-inbox fs-5 text-primary"></i>Inbox</a>
                                        </li>
                                        <li class="list-group-item border-0 p-0 mx-9">
            ...
            <div class="d-flex w-100" id="messagearea">
                                                            ...
                                                            <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start chat-user bg-light-subtle" onclick="viewchat(<?= $mgs->mcid ?>)" data-user-id="1">
                                                                ...
                                                                <div class="position-relative w-100 ms-2">
                                                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                                                        ...
                                                                        <span class="badge text-bg-success fs-2 rounded-2 py-1 px-2"> Sent <i class="fas fa-check-circle" style="font-size: 10px"></i> </span>
                                                                        <!-- <?php // if ($mgs->mcstat == 1) { 
                                                                                ?>
                ...
                <div class="w-100">
                    <div class="chat-container h-100 w-100" style="height: 100px">
