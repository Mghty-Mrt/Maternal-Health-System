    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover text-nowrap mb-2 align-middle text-center" id="minor">
                                ...
                                <td>
                                    <div class="dropdown dropstart">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" data-popper-placement="left-start">
                                            <?php if($m->o_status == 0){?>
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3 text-primary" href="javascript:void(0)"><i class="fs-4 ti ti-refresh"></i>For Counseling</a>
                                            </li>
                                            <?php } ?>
                                            <?php if($m->o_status == 1){?>
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3 text-secondary" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#view_counseling_modal" onclick="view_counseling(<?= $m->oreg_id ?>, '<?= $m->firstname ?> <?= $m->middlename ?> <?= $m->lastname ?>', '<?= $m->name ?>', '<?= $m->remarks ?>')"><i class="fs-4 ti ti-eye"></i>View</a>
                                            </li>
                                            <?php } ?>
                                            <!-- <li>
...
<div class="modal fade" id="view_counseling_modal" tabindex="-1" aria-labelledby="dynamicmodal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable rounded-1 modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h1 class="modal-title fs-5 text-light" id="modalTitle"><i class="fas fa-file"></i> View Counseling</h1>
                ...
                <div id="AP_details">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="remarks" id="remarks" rows="7" class="form-control shadow-none" placeholder="Type your remarks here..." readonly></textarea>
                        </div>
                    </div>
...
<script>
  ...
  function view_counseling(id, patient_name, guardian_name, remarks) {
        var oreg_id = id;
