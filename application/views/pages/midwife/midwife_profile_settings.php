                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none" href="../midwife/dashboard">Dashboard</a>
                            </li>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-2">
                    ...
                    <?php } else { ?>
                    <img src="/mhs_micro/profile/<?= $info->image ?>" class="img rounded-5" alt="profile" height="150px" width="180px">
                    <?php } ?>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <p>Last Name <br> <?php print $info->lastname ?></p>
                </div>
                <div class="col-md-4">
                    <p>First Name <br> <?php print $info->firstname ?></p>
                </div>
                <div class="col-md-4">
                    <p>Middle Name <br> <?php print $info->middlename ?></p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <p>Email Address<br> <?php print $info->email ?></p>
                </div>
                <div class="col-md-4">
                    <p>Contact Number <br> <?php print $info->mobileno ?></p>
                </div>
                <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-4">
                    <p>Company Email Address <br> <?php print $info->email ?></p>
                </div>
                <div class="col-md-4">
                    <p>Office Mobile Number <br> 09326475823</p>
                </div>
                <div class="col-md-4">
