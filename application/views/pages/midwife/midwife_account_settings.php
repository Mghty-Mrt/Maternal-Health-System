            ...
            <div class="row align-items-center">
                ...
                <div class="col-3">
                    <div class="text-center mb-n5">
                        <img src="../assets/images/logo/ChatBc.png" alt="" class="img-fluid mb-n4">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="card w-100 position-relative overflow-hidden">
                            <div class="card-body p-4">
                                <form id="profileForm" action="../midwife/saveprofile" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="card w-100 position-relative overflow-hidden">
                            <div class="card-body p-4">
                                ...
                                <form id="accountForm" action="../midwife/updatePass" method="POST">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-center justify-content-end mt-4 gap-3">
                                            ...
                                            <a href="../midwife/account" class="btn bg-danger-subtle text-danger">Cancel</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<?php if ($this->session->flashdata('success')) : ?>
    <script>
        const Toast1 = Swal.mixin({
            ...
            didClose: () => {
                window.location.href = "../midwife/account";
            }
        });
        Toast1.fire({
            icon: "success",
