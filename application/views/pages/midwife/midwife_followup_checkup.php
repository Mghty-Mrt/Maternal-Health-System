                            ...
                            <tr id="tr">
                                ...
                                <td class="border-bottom-0">
                                    <?php if ($today->visits == "1st Visit" && $today->checkUpStatus == 0) { ?>
                                        <a href="../midwife/preItrCheckup?id=<?= $today->pid ?>" class="btn btn-primary fs-2 btn-sm btnCheck"><i class="fs-3 ti ti-file-pencil"></i> Prenatal Checkup</a>
                                    <?php } else { ?>
                                        <a href="../midwife/prefollowupcheckup?id=<?= $today->pid ?>" class="btn btn-secondary fs-2 btn-sm btnCheck"><i class="fs-3 ti ti-file-pencil"></i> Follow-Up Checkup</a>
                                    <?php } ?>
                                    <a href="#" class="btn btn-success fs-2 btn-sm btnPostCheck" style="display:none;"><i class="fs-3 ti ti-file-pencil"></i> PostCheckUp</a>
                                    <!-- <button type="button" class="btn btn-danger fs-2 btn-sm btnReferral" style="display:none;" data-bs-toggle="modal" data-bs-target="#dynamicmodalref" data-id ="<?= $today->pppre ?>"><i class="fs-3 ti ti-send"></i> Referr Patient</button> -->
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
            ...
            <div class="modal-body" id="modalContent">
                ...
                <div class="row">
                    <?php foreach ($facilityType as $ft) { ?>
                        <div class="col-md-4">
                            <div class="card text-center bg-danger-subtle card-hover">
                                <div class="p-2 d-block mt-3">
                                    <img src="../assets/images/barangays/batasan.jpg" width="75" class="rounded-2 img-fluid" style="height: 100px; width: 100px;">
                                    ...
                                    <form method="post" action="../doctor/findfacilities">
                                        ...
                                        <button type="submit" class="btn btn-danger btn-sm  d-block w-100">Select <i class="fas fa-arrow-right"></i></button>
                                    </form>
                                </div>
                            </div>
                        </div>
