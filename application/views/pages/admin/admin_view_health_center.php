    ...
    <div class="card" id="pageLoad">
        <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
                <h5 class="card-title fw-bold text-uppercase fs-3"> <i class="fas fa-hospital fs-3"></i> <?php foreach($facility as $fac){ ?> <?= $fac->name ?> <?php } ?> / <span class="text-muted">Health Center Details</span></h5>
                <a href="../admin/healthcenter" class="btn btn-danger btn-sm"><i class="ti ti-arrow-back-up fw-semibold"></i> Back</a>
            </div>
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="users-tab" data-bs-toggle="tab" href="#users" role="tab" aria-controls="users" aria-selected="true">
                        <span><i class="fas fa-user-nurse"></i> Health Center Users</span>
                    </a>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="prenatal-tab" data-bs-toggle="tab" href="#prenatal" role="tab" aria-controls="prenatal" aria-selected="true">
                        <span><i class="fas fa-clipboard-list"></i> Overall Patients</span>
                    </a>
                </li>
                <!-- <li class="nav-item" role="presentation">
                    <a class="nav-link" id="prenatal-tab" data-bs-toggle="tab" href="#prenatal" role="tab" aria-controls="prenatal" aria-selected="true">
            ...
            <div class="tab-content tabcontent-border p-3" id="myTabContent">
                ...
                <div class="tab-pane fade" id="users" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="row">
                        <?php foreach ($HCusers as $persuhc) { ?>
                            <div class="col-md-3">
                ...
                <div class="tab-pane fade" id="profile5" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h5 class="card-title mb-4">Health Center Details / <span class="text-muted">Refer Patients</span></h5>
                        </div>
                        ...
                        <table class="table table-bordered table-hover text-nowrap mb-2 align-middle text-center" id="referpatients" data-order='[[0,"desc"]]'>
                            <thead class="text-dark fs-3 bg-home">
                                <tr>
                                    ...
                                    <th class="border-bottom-0">
                                        <h6 class="fw-semibold text-uppercase fs-2 text-light mb-0">Refer To</h6>
                                    </th>
                                    <th class="border-bottom-0">
                ...
                <div class="tab-pane fade" id="prenatal" role="tabpanel" aria-labelledby="prenatal-tab">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h5 class="card-title mb-4">Health Center Details / <span class="text-muted">Overall Patients</span></h5>
                        </div>
                        <div class="col-md-6 d-flex justify-content-end">
                            <button type="button" class="btn btn-danger btn-sm mb-4 mx-1" onclick="genarateOverAllPdf()"><i class="ti ti-download"></i> Pdf</button>
                            <button type="button" class="btn btn-success btn-sm mb-4 mx-1" onclick="dlOverAllToExcel()"><i class="ti ti-download"></i> Excel</button>
                            <button type="button" class="btn btn-warning btn-sm mb-4 mx-1" onclick="printOverAllPdf()"><i class="ti ti-printer"></i> Print</button>

                        </div>
                    </div>
                    <div class="table-responsive" id="Over_all">
                        <table class="table table-bordered table-hover text-nowrap mb-2 align-middle text-center" id="allpatients" data-order='[[0,"desc"]]'>
                            ...
                            <tbody id="tbl_content">
                                <?php foreach($overallpatients as $all){ ?>
                                <tr id="tr">
                                    <td class="border-bottom-0"> <?= $all->pid ?></td>
                                    <td class="border-bottom-0"> <?= $all->firstname ?> <?= $all->middlename ?> <?= $all->lastname ?> </td>
                                    <td class="border-bottom-0"> <?= $all->visits ?> </td>
                                    <td class="border-bottom-0"> <?= $all->ptname?> </td>
                                    <td class="border-bottom-0">
                                        <?php if($all->checkUpStatus == 0){ ?>
                                            For CheckUp
                                        <?php } elseif($all->checkUpStatus == 1) { ?>
                                            Done CheckUp
                                        <?php } ?>
    ...
    function viewhcuser(suid){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#modalTitle').html('<i class="fas fa-info-circle"></i> Health Center User Details')
