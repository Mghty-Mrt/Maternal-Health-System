                    ...
                    <div class="col-md-4">
                        <div class="card card-hover">
                            <div class="card-body">
                                ...
                                <?php } else { ?>
                                    <img src="/mhs_micro/facilities/<?php print $perhc->image ?>" class="rounded-3 img-fluid" style="height: 200px" width="100%">
                                <?php } ?>
                            ...
                            <div class="d-flex justify-content-between card-footer">
                                <span><i class="fas fa-archive text-danger bg-danger-subtle rounded-circle p-2"></i></span>
