<form action="../admin/submitbrgyuser" method="POST" onsubmit="return validateForm()">
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <!-- <div id="invalidBrgy" class="invalid-feedback" style="display: none;"></div> -->
        </div>
...
<script>
    function validateForm() {
        ...
        // var brgy = $('#brgy').val();
        // if (!brgy) {
        //     $('#invalidBrgy').html('<i class="fas fa-exclamation-circle ms-2"></i> Barangay is required.');
        //     $('#invalidBrgy').show();
        //     $('#brgy').addClass('is-invalid');
        //     isValid = false;
        // } else {
        //     $('#invalidBrgy').hide();
        //     $('#brgy').removeClass('is-invalid');
        // }
