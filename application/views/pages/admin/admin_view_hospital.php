    ...
    <div class="card" id="pageLoad">
        <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
                <h5 class="card-title fw-bold text-uppercase fs-3"> <i class="fas fa-hospital-alt fs-3"></i> <?php foreach ($facility as $fac) { ?> <?= $fac->name ?> <?php } ?> / <span class="text-muted">Hospital Details</span></h5>
                <a href="../admin/hospital" class="btn btn-danger btn-sm"><i class="ti ti-arrow-back-up fw-semibold"></i> Back</a>
            </div>
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="users-tab" data-bs-toggle="tab" href="#users" role="tab" aria-controls="users" aria-selected="true">
                        <span><i class="fas fa-user-nurse"></i> Hospital Users</span>
                    </a>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content tabcontent-border p-3" id="myTabContent">
                ...
                <div class="tab-pane fade" id="users" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="row">
                        <?php foreach ($Husers as $persuhc) { ?>
                            <div class="col-md-3">
                                <div class="card hover-img">
                                    <div class="card-body p-4 text-center border-bottom">
                                        <?php if ($persuhc->image == "") { ?>
                                            <img src="../assets/images/profile/default.jpg" alt="" class="rounded-3 mb-3" width="80" height="80">
                                        <?php } else { ?>
                                            <img src="/mhs_micro/profile/<?php print $persuhc->image ?>" alt="" class="rounded-3 mb-3" width="80" height="80">
                                        <?php } ?>
                                        <h5 class="fw-semibold mb-0 fs-5"><?php print $persuhc->firstname ?> <?php print $persuhc->lastname ?></h5>
                                        <span class="text-dark fs-2"><?php print $persuhc->rname ?></span><br>
                                    ...
                                    <ul class="px-2 py-2 list-unstyled d-flex align-items-center justify-content-center mb-0 card-footer bg-home">
                                        <button type="button" class="btn text-light btn-sm rounded-1" data-bs-toggle="modal" data-bs-target="#dynamicmodal" onclick="viewhcuser(<?= $persuhc->suid ?>)"><i class="fas fa-info-circle"></i> View</button>
                ...
                <div role="tabpanel" class="tab-pane fade" id="home5" aria-labelledby="home-tab">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h5 class="card-title mb-4 fs-4">Hospital Details / <span class="text-muted">Equipments</span></h5>
                        </div>
                        <div class="col-md-6 d-flex justify-content-end">
                            <button type="button" class="btn btn-danger btn-sm mb-4 mx-1" onclick="dlequiPdf()"><i class="ti ti-download"></i> Pdf</button>
                            <button type="button" class="btn btn-success btn-sm mb-4 mx-1" onclick="dlequiExcel()"><i class="ti ti-download"></i> Excel</button>
                            <button type="button" class="btn btn-warning btn-sm mb-4 mx-1" onclick="printequiPdf()"><i class="ti ti-printer"></i> Print</button>

                        </div>
                    </div>

                    <div class="table-responsive" id="equi_tbl">
                        <table class="table table-bordered table-hover text-nowrap mb-2 align-middle text-center" id="equi" data-order='[[0,"desc"]]'>
                            <thead class="text-dark fs-3 bg-home">
                                <tr>
                                    ...
                                    <th class="border-bottom-0">
                                        <h6 class="fw-semibold text-uppercase fs-2 text-light mb-0">Availabe Quantity</h6>
                                    </th>
                                    <th class="border-bottom-0">
                            ...
                            <tbody id="tbl_content">
                                <?php foreach ($equipments as $equi) { ?>
                                    <tr id="tr">
                ...
                <div class="tab-pane fade" id="profile5" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h5 class="card-title mb-4">Hospital Details / <span class="text-muted">Referred Patients</span></h5>
                        </div>
                        <div class="col-md-6 d-flex justify-content-end">
                            <button type="button" class="btn btn-danger btn-sm mb-4 mx-1" onclick="dlrefPdf()"><i class="ti ti-download"></i> Pdf</button>
                            <button type="button" class="btn btn-success btn-sm mb-4 mx-1" onclick="dlrefExcel()"><i class="ti ti-download"></i> Excel</button>
                            <button type="button" class="btn btn-warning btn-sm mb-4 mx-1" onclick="printrefPdf()"><i class="ti ti-printer"></i> Print</button>

                        </div>
                    </div>
                    <div class="table-responsive" id="referral_tbl">
                        <table class="table table-bordered table-hover text-nowrap mb-2 align-middle text-center" id="refer_patients" data-order='[[0,"desc"]]'>
                            <thead class="text-dark fs-3 bg-home">
                                <tr>
                                    <th class="border-bottom-0">
                                    ...
                                    <th class="border-bottom-0">
                                        <h6 class="fw-semibold text-uppercase fs-2 text-light mb-0">Referral Date </h6>
                                    </th>
                                    <th class="border-bottom-0">
                ...
                <div class="tab-pane fade" id="prenatal" role="tabpanel" aria-labelledby="prenatal-tab">
                    ...
                    <div class="row border-bottom">
                        <div class="col-md-6">
                            <h5 class="card-title mb-4">Hospital Details / <span class="text-muted">Bed Slot</span></h5>
                        </div>
                        <div class="col-md-6 d-flex justify-content-end">
...
<script>
    ...
    function dlequiExcel() {
        var table = $('#equi').DataTable();
        ...
        var tableTitle = "Hospital_Equipments";
...
<script>
    function printequiPdf() {
        let jsPdf = new jsPDF('p', 'pt', 'Legal');
        var htmlElement = document.getElementById('equi_tbl');
...
<script>
    ...
    function dlequiPdf() {
        ...
        html2canvas(htmlElement, {
            ...
            jsPdf.addImage(imgData, 'PNG', leftMargin, topMargin, pdfWidth - 60, imgHeight);
            jsPdf.save("Hospital_Equipments.pdf");
...
<script>
    $(document).ready(function() {
        $('#refer_patients').DataTable();
    });

    function dlrefExcel() {
        var table = $('#refer_patients').DataTable();
        ...
        var tableTitle = "Hospital_Refer_Patients";
...
<script>
    function printrefPdf() {
        let jsPdf = new jsPDF('p', 'pt', 'Legal');
        var htmlElement = document.getElementById('referral_tbl');
...
<script>
    ...
    function dlrefPdf() {
        ...
        html2canvas(htmlElement, {
            ...
            jsPdf.addImage(imgData, 'PNG', leftMargin, topMargin, pdfWidth - 60, imgHeight);
            jsPdf.save("Hospital_Refer_Patients.pdf");
            window.open(jsPdf.output('bloburl'));
        });
...
<script>
    function printbedPdf() {
        let jsPdf = new jsPDF('p', 'pt', 'Legal');
        var htmlElement = document.getElementById('bed_slot');
...
<script>
    ...
    function dlbedPdf() {
        ...
        html2canvas(htmlElement, {
            ...
            jsPdf.addImage(imgData, 'PNG', leftMargin, topMargin, pdfWidth - 60, imgHeight);
            jsPdf.save("Hospital_bed_slot.pdf");
            window.open(jsPdf.output('bloburl'));
        });
    ...
    function viewhcuser(suid) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#modalTitle').html('<i class="fas fa-info-circle"></i> Hospital User Details')
